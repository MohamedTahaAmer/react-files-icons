 ...
 */
export function getIconNameForFolder(folderName: string) {
 ...
 * @return icon filename
 */
export function getIconNameForFile(fileName: string) {
 ...
 * @return icon filename
 */
export function getIconNameForOpenFolder(folderName: string) {
	return getIconNameForFolder(folderName).split(".").shift() + "_opened.svg"
}
