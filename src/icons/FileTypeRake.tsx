...
const FileTypeRake = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_rake</title>{" "}
		<polygon
			points="16.043 2 23.357 6.249 23.358 13.62 29.677 17.262 29.677 25.902 22.441 30 16.043 26.368 9.646 30 2.323 25.818 2.323 17.262 8.663 13.639 8.672 6.259 16.043 2"
			style={{ fill: "#666" }}
		/>{" "}
