...
const FileTypeAffinityphoto = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<radialGradient id="a" cx="15.015" cy="18.156" r="11.547" gradientUnits="userSpaceOnUse">
			{" "}
			<stop offset=".216" stopColor="#ffb3c0" /> <stop offset=".491" stopColor="#fd6ee4" />{" "}
			<stop offset="1" stopColor="#ac3dff" />{" "}
		</radialGradient>{" "}
		<path
			fill="url(#a)"
			d="M15.885 16.016l-2.33-4.051-2.34 4.051zm-1.414 4.664l1.313 2.282h12.329L26.8 20.68zm-1.684-1.814l-3.654 6.328h7.293zm4.051 1.324h9.68l-4.83-8.398zm-2.962-8.78l3.675 6.39 3.804-6.587-3.675-6.39zM8.507 25.194l5.019-8.691h-2.592l-5.019 8.691z"
		/>{" "}
		<path
			d="M15.867 20.079H14.46a.586.586 0 0 1-.504-.287l-.689-1.159a.585.585 0 0 1 0-.599l.689-1.159a.586.586 0 0 1 .504-.287h1.406c.207 0 .398.109.504.287l.689 1.159c.11.185.11.415 0 .599l-.689 1.159a.582.582 0 0 1-.503.287z"
			fill="#43004d"
		/>{" "}
	</svg>
)
