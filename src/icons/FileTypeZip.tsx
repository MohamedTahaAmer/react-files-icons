...
const FileTypeZip = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient id="a" x1="17.65" y1="26.056" x2="21.099" y2="26.056" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#4d4d4d" /> <stop offset="0.5" stopColor="#fff" />{" "}
				<stop offset="1" stopColor="#4d4d4d" />{" "}
			</linearGradient>{" "}
			<linearGradient id="b" x1="17.65" y1="23.756" x2="21.099" y2="23.756" xlinkHref="#a" />{" "}
			<linearGradient id="c" x1="17.65" y1="21.456" x2="21.099" y2="21.456" xlinkHref="#a" />{" "}
			<linearGradient id="d" x1="17.65" y1="19.156" x2="21.099" y2="19.156" xlinkHref="#a" />{" "}
			<linearGradient id="e" x1="17.65" y1="16.857" x2="21.099" y2="16.857" xlinkHref="#a" />{" "}
			<linearGradient id="f" x1="17.65" y1="14.557" x2="21.099" y2="14.557" xlinkHref="#a" />{" "}
			<linearGradient id="g" x1="17.65" y1="12.257" x2="21.099" y2="12.257" xlinkHref="#a" />{" "}
			<linearGradient id="h" x1="17.65" y1="9.957" x2="21.099" y2="9.957" xlinkHref="#a" />{" "}
			<linearGradient id="i" x1="17.65" y1="7.657" x2="21.099" y2="7.657" xlinkHref="#a" />{" "}
			<linearGradient id="j" x1="16.237" y1="27.217" x2="19.686" y2="27.217" xlinkHref="#a" />{" "}
			<linearGradient id="k" x1="16.237" y1="24.918" x2="19.686" y2="24.918" xlinkHref="#a" />{" "}
			<linearGradient id="l" x1="16.237" y1="22.618" x2="19.686" y2="22.618" xlinkHref="#a" />{" "}
			<linearGradient id="m" x1="16.237" y1="20.318" x2="19.686" y2="20.318" xlinkHref="#a" />{" "}
			<linearGradient id="n" x1="16.237" y1="18.018" x2="19.686" y2="18.018" xlinkHref="#a" />{" "}
			<linearGradient id="o" x1="17.65" y1="28.356" x2="21.099" y2="28.356" xlinkHref="#a" />{" "}
			<linearGradient id="p" x1="16.237" y1="15.718" x2="19.686" y2="15.718" xlinkHref="#a" />{" "}
			<linearGradient id="q" x1="16.237" y1="13.419" x2="19.686" y2="13.419" xlinkHref="#a" />{" "}
			<linearGradient id="r" x1="16.237" y1="11.119" x2="19.686" y2="11.119" xlinkHref="#a" />{" "}
			<linearGradient id="s" x1="16.237" y1="8.819" x2="19.686" y2="8.819" xlinkHref="#a" />{" "}
			<linearGradient id="t" x1="16.237" y1="29.514" x2="19.686" y2="29.514" xlinkHref="#a" />{" "}
			<linearGradient id="u" x1="16.985" y1="11.196" x2="20.446" y2="11.196" xlinkHref="#a" />{" "}
			<linearGradient id="v" x1="18.096" y1="5.329" x2="19.336" y2="5.329" xlinkHref="#a" />{" "}
			<linearGradient id="w" x1="16.029" y1="5.591" x2="21.403" y2="5.591" xlinkHref="#a" />{" "}
		</defs>{" "}
		<title>file_type_zip</title>{" "}
		<path
			d="M27.667,27.667V17.333L23,15V2H4.333V30H27.667Zm-4.667,0V18.556l2.333,1.222v7.889Z"
			style={{ fill: "#c09553" }}
		/>{" "}
