...
const FileTypePhpcsfixer = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		{" "}
		<defs>
			{" "}
			<linearGradient id="a" x1="11.813" y1="29.627" x2="19.304" y2="1.668" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0.162" stopColor="#ccb37e" /> <stop offset="0.171" stopColor="#c8ad7f" />{" "}
				<stop offset="0.199" stopColor="#c1a282" /> <stop offset="0.239" stopColor="#bc9b84" />{" "}
				<stop offset="0.35" stopColor="#bb9984" /> <stop offset="0.356" stopColor="#b89580" />{" "}
				<stop offset="0.397" stopColor="#aa826a" /> <stop offset="0.445" stopColor="#9f7359" />{" "}
				<stop offset="0.505" stopColor="#97684e" /> <stop offset="0.588" stopColor="#926247" />{" "}
				<stop offset="0.82" stopColor="#916045" /> <stop offset="0.825" stopColor="#875f48" />{" "}
				<stop offset="0.837" stopColor="#765c4d" /> <stop offset="0.852" stopColor="#6b5a50" />{" "}
				<stop offset="0.872" stopColor="#645952" /> <stop offset="0.93" stopColor="#625953" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		<title>file_type_phpcsfixer</title>{" "}
		<path
...
export default FileTypePhpcsfixer
