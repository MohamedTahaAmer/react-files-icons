...
const FileTypePowershellTypes = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#57f757" /> <stop offset="1" stopColor="#4a4" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="7.1"
			...
			>
				{" "}
				<stop offset="0" stopColor="#57f757" /> <stop offset="1" stopColor="#41b741" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		...
		<path
			...
			style={{ fill: "#2e892e", fillRule: "evenodd" }}
		/>{" "}
		<path
