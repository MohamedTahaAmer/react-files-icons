...
const FileTypePowershell = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#5391fe" /> <stop offset="1" stopColor="#3e6dbf" />{" "}
			</linearGradient>{" "}
			<linearGradient id="b" x1="7.1" y1="-104.002" x2="23.001" y2="-118.292" xlinkHref="#a" />{" "}
		</defs>{" "}
		...
		<path
			...
			style={{ fill: "#2c5591", fillRule: "evenodd" }}
		/>{" "}
		<path
