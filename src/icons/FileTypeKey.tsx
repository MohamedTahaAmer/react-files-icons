...
const FileTypeKey = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient
				...
				x2="15.469"
				y2="106.745"
				gradientTransform="matrix(0.994, 0.114, -0.114, 0.994, 21.345, -80.478)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0.365" stopColor="#961b1e" /> <stop offset="0.697" stopColor="#961b1e" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="15.297"
			...
			>
				{" "}
				<stop offset="0.326" stopColor="#c0272d" /> <stop offset="0.82" stopColor="#c0272d" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="c"
				x1="-3310.623"
				...
				x2="-3310.854"
				y2="808.435"
				gradientTransform="matrix(-1.071, 0.315, 0.248, 0.986, -3724.367, 274.118)"
				xlinkHref="#a"
			/>{" "}
			<linearGradient
				id="d"
			...
			<linearGradient id="e" x1="22.94" y1="23.821" x2="22.874" y2="14.932" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#651116" /> <stop offset="0.053" stopColor="#6a1217" />{" "}
				<stop offset="0.463" stopColor="#901b20" /> <stop offset="0.793" stopColor="#a72126" />{" "}
				<stop offset="1" stopColor="#b02328" />{" "}
			</linearGradient>{" "}
			<radialGradient
				id="f"
				cx="131.214"
				cy="24.534"
				r="172.942"
				gradientTransform="translate(19.08 18.916) scale(0.028 0.028)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0.478" stopColor="#ec1c24" /> <stop offset="0.775" stopColor="#961b1e" />{" "}
				<stop offset="1" stopColor="#d9383c" />{" "}
			</radialGradient>{" "}
			<linearGradient id="g" x1="24.269" y1="22.368" x2="21.317" y2="16.316" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0.006" stopColor="#ca4849" /> <stop offset="0.421" stopColor="#c0272d" />{" "}
				<stop offset="1" stopColor="#730b0d" />{" "}
			</linearGradient>{" "}
			<radialGradient
				id="h"
				cx="137.714"
				cy="50.972"
				r="170.148"
				gradientTransform="translate(19.021 18.917) scale(0.027 0.027)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0.618" stopColor="#6c0607" /> <stop offset="0.994" stopColor="#b12328" />{" "}
			</radialGradient>{" "}
			<radialGradient
				id="i"
				cx="-127.767"
				cy="14.566"
				r="120.907"
				gradientTransform="translate(19.287 19.73) rotate(180) scale(0.027 0.027)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0.876" stopColor="#c0272d" /> <stop offset="1" stopColor="#831416" />{" "}
			</radialGradient>{" "}
			<linearGradient id="j" x1="24.103" y1="22.049" x2="21.475" y2="16.617" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0.006" stopColor="#ca4849" /> <stop offset="0.421" stopColor="#c0272d" />{" "}
				<stop offset="1" stopColor="#651116" />{" "}
			</linearGradient>{" "}
			<radialGradient
				id="k"
				cx="-95.684"
			...
			>
				{" "}
				<stop offset="0" stopColor="#c5263b" /> <stop offset="1" stopColor="#910d10" />{" "}
			</radialGradient>{" "}
			<linearGradient id="l" x1="24.273" y1="22.551" x2="21.218" y2="16.168" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0.017" stopColor="#b12328" /> <stop offset="0.096" stopColor="#d9383c" />{" "}
				<stop offset="0.994" stopColor="#651116" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="m"
				x1="382.633"
			...
			>
				{" "}
				<stop offset="0" stopColor="#ffe800" /> <stop offset="1" stopColor="#dfb300" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="n"
				x1="383.31"
			...
			>
				{" "}
				<stop offset="0" stopColor="#ffe800" stopOpacity="0.392" />{" "}
				<stop offset="1" stopColor="#dfb300" stopOpacity="0.392" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="o"
				x1="206.294"
				...
				x2="197.914"
				y2="-122.585"
				gradientTransform="matrix(0.707, 0.707, 0.707, -0.707, -37.241, -222.037)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0" stopColor="#dfb300" /> <stop offset="0.5" stopColor="#dfb300" />{" "}
				<stop offset="1" stopColor="#dfb300" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="p"
				x1="-722.753"
				...
				x2="-727.648"
				y2="-709.665"
				gradientTransform="translate(859.396 -852.482) rotate(-90) scale(1.188)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
		...
		<path
			d="M6.354,3.748v24.5H25.619V8.115h-4.8V3.748ZM22.549,4.832l.011,1.544h1.669l-1.68-1.547Z"
			style={{ fill: "gray" }}
		/>{" "}
		<path
		...
		/>{" "}
		<path
			d="M22.749,15.428s.8-.436,1.211-.214a1.13,1.13,0,0,0-.657.037A2.216,2.216,0,0,1,22.749,15.428Z"
			style={{ fill: "#fadae8" }}
		/>{" "}
		<path
		...
		/>{" "}
		<path
			d="M26.189,21.5s.111.605-.258.819-.413.111-.413.111a.659.659,0,0,0,.509-.273A1.1,1.1,0,0,0,26.189,21.5Z"
			style={{ fill: "#ca4849" }}
		/>{" "}
		<path
			d="M18.782,19.012a2.11,2.11,0,0,0,.207,1.668s-.155-.546-.2-.7A2.1,2.1,0,0,1,18.782,19.012Z"
			style={{ fill: "#f8cce0" }}
		/>{" "}
		...
		/>{" "}
		<path
			d="M26.6,18.4a1.036,1.036,0,0,1,.5.841,1.333,1.333,0,0,0-.393-.7S26.475,18.383,26.6,18.4Z"
			style={{ fill: "#fadae8" }}
		/>{" "}
		...
		/>{" "}
		<path
			d="M22.971,22.927a2.591,2.591,0,0,0,1.285-.339A2.964,2.964,0,0,1,22.971,22.927Z"
			style={{ fill: "#f8c9dd" }}
		/>{" "}
		<path
