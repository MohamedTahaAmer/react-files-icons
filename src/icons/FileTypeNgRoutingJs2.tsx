...
const FileTypeNgRoutingJs2 = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_ng_routing_js2</title>{" "}
		<polyline
			points="15.604 30 26.65 23.882 28.638 6.648 15.604 2 15.604 2 15.604 2 2.57 6.648 4.558 23.882 15.604 30"
			style={{ fill: "#dbdb00" }}
		/>{" "}
		<polyline
			points="15.604 30 26.65 23.882 28.638 6.648 15.604 2 15.604 5.108 15.604 5.094 15.604 19.276 15.604 19.276 15.604 30"
			style={{ fill: "#c1c100" }}
		/>{" "}
		<path
