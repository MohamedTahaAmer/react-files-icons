...
const FileTypeAppscript = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
		{" "}
		<rect width="373" height="107" x="27.53" y="328.9" fill="#ea4335" rx="53.5" />{" "}
		...
		<g>
			...
			/>{" "}
			<circle cx="348.22" cy="381.64" r="26.7" fill="#fff" /> <circle cx="430.67" cy="127.89" r="26.7" fill="#fff" />{" "}
		</g>{" "}
	</svg>
)
