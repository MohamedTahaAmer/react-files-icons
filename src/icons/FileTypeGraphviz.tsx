...
const FileTypeGraphviz = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_graphviz</title>{" "}
		<polygon
			points="23.942 30 12.679 30 1.417 30 1.417 16 1.417 2 12.679 2 23.942 2 23.942 16 23.942 30"
			style={{ fill: "#e6e6e6" }}
		/>{" "}
		...
		/>{" "}
		<path
			d="M6.2,23.477A27.4,27.4,0,0,1,9.769,8.986l.687.391A26.609,26.609,0,0,0,6.986,23.45Z"
			style={{ fill: "#656565" }}
		/>{" "}
		<path
			d="M10.853,7.957a7.171,7.171,0,0,0-.075,2.32l-.758-.93-1.178-.23A7.165,7.165,0,0,0,10.853,7.957Z"
			style={{ fill: "#656565" }}
		/>{" "}
		<path
		...
		/>{" "}
		<path
			d="M15.2,7.957a7.171,7.171,0,0,0,2.011,1.159l-1.178.23-.758.93A7.165,7.165,0,0,0,15.2,7.957Z"
			style={{ fill: "#656565" }}
		/>{" "}
		<rect
			x="11.348"
		...
		/>{" "}
		<path
			d="M13.054,13.529a7.171,7.171,0,0,0-1.1-2.046l1.122.426,1.135-.39A7.165,7.165,0,0,0,13.054,13.529Z"
			style={{ fill: "#656565" }}
		/>{" "}
		<rect
			x="7.809"
			...
			width="4.757"
			height="0.791"
			transform="translate(-12.56 18.108) rotate(-57.603)"
			style={{ fill: "#656565" }}
		/>{" "}
		<path
			d="M8.147,23.694a7.171,7.171,0,0,0,.133-2.317l.734.949,1.171.26A7.165,7.165,0,0,0,8.147,23.694Z"
			style={{ fill: "#656565" }}
		/>{" "}
		<rect
			x="15.418"
			...
			width="0.791"
			height="4.919"
			transform="translate(-8.257 10.951) rotate(-30.708)"
			style={{ fill: "#656565" }}
		/>{" "}
		<path
			d="M17.8,23.856a7.171,7.171,0,0,0-2.006-1.168l1.179-.225.762-.927A7.165,7.165,0,0,0,17.8,23.856Z"
			style={{ fill: "#656565" }}
		/>{" "}
		<path
		...
		<rect
			...
			width="2.147"
			height="0.44"
			transform="translate(-7.74 14.465) rotate(-31.394)"
			style={{ fill: "#282828" }}
		/>{" "}
		<rect
			x="22.868"
			...
			width="2.147"
			height="6.887"
			transform="translate(-9.207 16.044) rotate(-31.394)"
			style={{ fill: "#282828" }}
		/>{" "}
		<path
...
export default FileTypeGraphviz
