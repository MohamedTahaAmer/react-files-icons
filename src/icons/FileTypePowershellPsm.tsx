...
const FileTypePowershellPsm = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#f955f9" /> <stop offset="1" stopColor="#ad44ad" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="7.1"
			...
			>
				{" "}
				<stop offset="0" stopColor="#f955f9" /> <stop offset="1" stopColor="#ba3fba" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		...
		<path
			...
			style={{ fill: "#8c2d8a", fillRule: "evenodd" }}
		/>{" "}
		<path
