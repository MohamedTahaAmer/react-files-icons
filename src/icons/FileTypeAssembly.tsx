...
const FileTypeAssembly = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#fff" stopOpacity="0" /> <stop offset="1" stopColor="#fff" stopOpacity="0.275" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		...
		<path
			...
			style={{ fill: "#fff", fillOpacity: "0.165680468082428" }}
		/>{" "}
		<path
