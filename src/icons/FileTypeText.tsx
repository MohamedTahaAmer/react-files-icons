...
const FileTypeText = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<path
			...
			style={{ fill: "#c2c2c2" }}
		/>{" "}
		<rect x="8.125" y="15.097" width="13.076" height="1.75" style={{ fill: "#829ec2" }} />{" "}
		<rect x="8.125" y="24.439" width="9.762" height="1.75" style={{ fill: "#829ec2" }} />{" "}
		<rect x="8.125" y="19.763" width="15.75" height="1.75" style={{ fill: "#829ec2" }} />{" "}
		<rect x="8.125" y="10.23" width="15.75" height="1.75" style={{ fill: "#829ec2" }} />{" "}
	</svg>
)
