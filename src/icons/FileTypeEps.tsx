...
const FileTypeEps = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#fff" /> <stop offset="1" stopColor="#e6e6e6" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="-403.546"
			...
			>
				{" "}
				<stop offset="0" stopColor="#949494" /> <stop offset="1" stopColor="#8c8c8c" />{" "}
			</linearGradient>{" "}
			<linearGradient id="c" x1="-403.546" y1="-336.987" x2="-403.376" y2="-336.987" xlinkHref="#b" />{" "}
			<linearGradient
				id="d"
				x1="-405.673"
				y1="-336.64"
			...
			>
				{" "}
				<stop offset="0" stopColor="#b3b3b3" /> <stop offset="1" stopColor="#f2f2f2" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		...
		<rect
			...
			width="0.18"
			height="11.866"
			transform="translate(-5.802 20.788) rotate(-45.103)"
			style={{ fill: "#999" }}
		/>{" "}
