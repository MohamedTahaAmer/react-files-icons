...
const FileTypeLicensebat = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient id="a" x1="2.591" y1="16" x2="29.409" y2="16" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#ffca3f" /> <stop offset="0.014" stopColor="#fec83e" />{" "}
				<stop offset="0.238" stopColor="#ebaf35" /> <stop offset="0.471" stopColor="#de9d2e" />{" "}
				<stop offset="0.717" stopColor="#d6922a" /> <stop offset="0.999" stopColor="#d38f29" />{" "}
			</linearGradient>{" "}
			<linearGradient id="b" x1="19.532" y1="27.942" x2="11.214" y2="16.674" xlinkHref="#a" />{" "}
		</defs>{" "}
