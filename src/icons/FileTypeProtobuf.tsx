...
const FileTypeProtobuf = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_protobuf</title>{" "}
		<polygon
			points="15.996 3.22 26.966 9.7 26.954 22.3 16 28.78 5.038 22.408 5.034 9.628 15.996 3.22"
			style={{ fill: "#fff" }}
		/>{" "}
		<path
			d="M16,2,3.987,9.02l0,14L16,30l12-7.1.013-13.8ZM26.954,22.3,16,28.78,5.038,22.408l0-12.78L16,3.22,26.966,9.7Z"
			style={{ fill: "#171c1e" }}
		/>{" "}
		...
		/>{" "}
		<polygon
			points="19.226 6.606 19.226 8.374 11.21 13.074 11.21 23.172 9.808 23.988 9.835 12.277 19.226 6.606"
			style={{ fill: "#ff274b" }}
		/>{" "}
		<polygon
			points="16.16 4.784 6.53 10.394 6.529 22.071 9.827 23.988 9.835 12.277 19.235 6.606 16.16 4.784"
			style={{ fill: "#ff5c77" }}
		/>{" "}
	</svg>
)
