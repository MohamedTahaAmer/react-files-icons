...
const FileTypeUnlicense = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_unlicense</title>{" "}
		<path d="M23.627,14.143a7.763,7.763,0,0,0-.807-2.034l-2.034,2.034Z" style={{ fill: "gray" }} />{" "}
		<path
		...
		/>{" "}
		<path
			d="M16,20.286a4.225,4.225,0,0,1-1.174-.184L12.109,22.82a7.844,7.844,0,0,0,11.555-5.106h-3.74A4.283,4.283,0,0,1,16,20.286Z"
			style={{ fill: "gray" }}
		/>{" "}
		<path
