...
const FolderTypeDocsOpened = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>folder_type_docs_opened</title>{" "}
		<path
			d="M27.4,5.5H18.2L16.1,9.7H4.3V26.5H29.5V5.5Zm0,18.7H6.6V11.8H27.4Zm0-14.5H19.2l1-2.1h7.1V9.7Z"
			style={{ fill: "#dc7a7a" }}
		/>{" "}
		<polygon points="4.3 26.5 29.5 26.5 25.7 13.7 25.7 13.7 0.5 13.7 4.3 26.5" style={{ fill: "#dc7a7a" }} />{" "}
		<path
			d="M15.266,11.311V29.686H29.715v-15.1h-3.6V11.311H15.266Zm12.146.813.008,1.158,1.252,0-1.26-1.16Z"
			style={{ fill: "gray" }}
		/>{" "}
		<path
			...
			style={{ fill: "#c5c5c5" }}
		/>{" "}
		<rect x="16.594" y="19.372" width="11.813" height="1.313" style={{ fill: "#c5c5c5" }} />{" "}
		<path
		...
		<path
			...
			style={{ fill: "#c5c5c5" }}
		/>{" "}
		<rect x="16.594" y="27.805" width="8.203" height="1.313" style={{ fill: "#c5c5c5" }} />{" "}
		<rect x="16.594" y="25.272" width="11.813" height="1.313" style={{ fill: "#c5c5c5" }} />{" "}
		<rect x="16.594" y="22.272" width="11.813" height="1.313" style={{ fill: "#c5c5c5" }} />{" "}
		<rect x="16.649" y="16.472" width="11.813" height="1.313" style={{ fill: "#c5c5c5" }} />{" "}
	</svg>
)
export default FolderTypeDocsOpened
