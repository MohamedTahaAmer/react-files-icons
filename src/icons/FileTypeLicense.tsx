...
const FileTypeLicense = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient
				...
				x2="-255.586"
				y2="182.061"
				gradientTransform="matrix(-0.897, 0.441, 0.441, 0.897, -292.36, -27.561)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0" stopColor="#bd6316" /> <stop offset="1" stopColor="#4e1500" />{" "}
			</linearGradient>{" "}
			<linearGradient id="b" x1="-263.276" y1="170.205" x2="-256.603" y2="171.772" xlinkHref="#a" />{" "}
			<linearGradient id="c" x1="-265.068" y1="175.732" x2="-256.777" y2="178.801" xlinkHref="#a" />{" "}
			<linearGradient
				id="d"
				x1="-655.014"
				y1="147.549"
			...
			>
				{" "}
				<stop offset="0" stopColor="#ffd436" /> <stop offset="1" stopColor="#8b3f02" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="e"
				x1="-258.899"
			...
			>
				{" "}
				<stop offset="0" stopColor="#fff8b7" /> <stop offset="1" stopColor="#fcbf0e" />{" "}
			</linearGradient>{" "}
			<linearGradient id="f" x1="-258.884" y1="170.975" x2="-253.896" y2="171.314" xlinkHref="#a" />{" "}
			<linearGradient
				id="g"
				x1="-257.805"
				y1="172.266"
				...
				xlinkHref="#d"
			/>{" "}
			<linearGradient id="h" x1="-258.935" y1="181.92" x2="-256.173" y2="182.108" xlinkHref="#e" />{" "}
			<linearGradient
				id="i"
				x1="-274.156"
				y1="170.544"
				x2="-274.512"
				y2="173.778"
				gradientTransform="matrix(-1, 0, 0, 1, -257.657, -155.509)"
				xlinkHref="#d"
			/>{" "}
			<linearGradient
				id="j"
			...
			>
				{" "}
				<stop offset="0" stopColor="#ffef94" /> <stop offset="1" stopColor="#ffd200" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="k"
				x1="-276.128"
				...
				x2="-274.754"
				y2="178.682"
				gradientTransform="matrix(-0.897, 0.441, 0.441, 0.897, -305.235, -16.952)"
				xlinkHref="#d"
			/>{" "}
			<linearGradient
				id="l"
			...
			>
				{" "}
				<stop offset="0" stopColor="#d89530" /> <stop offset="1" stopColor="#772d00" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="n"
				x1="-274.075"
				...
				xlinkHref="#d"
			/>{" "}
			<linearGradient id="o" x1="-272.919" y1="189.281" x2="-273.315" y2="174.57" xlinkHref="#m" />{" "}
			<linearGradient
				id="p"
				x1="-273.177"
				y1="174.071"
			...
			>
				{" "}
				<stop offset="0" stopColor="#ffdb57" /> <stop offset="1" stopColor="#b55c13" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="r"
				x1="-665.076"
			...
			<linearGradient
				...
				xlinkHref="#m"
			/>{" "}
			<linearGradient id="u" x1="-655.442" y1="147.568" x2="-654.817" y2="146.776" xlinkHref="#d" />{" "}
			<linearGradient
				id="v"
				x1="-253.999"
				y1="175.1"
			...
			<linearGradient
				...
				x2="-505.041"
				y2="-57.638"
				gradientTransform="matrix(-0.947, -0.323, -0.148, 0.966, -476.554, -85.464)"
				xlinkHref="#a"
			/>{" "}
			<linearGradient
				id="ac"
			...
			<linearGradient
				...
				x2="-662.762"
				y2="-197.768"
				gradientTransform="matrix(-0.564, -0.911, -0.774, 0.455, -516.113, -497.612)"
				xlinkHref="#d"
			/>{" "}
			<linearGradient
				id="af"
			...
			<linearGradient
				...
				x2="-523.966"
				y2="-65.918"
				gradientTransform="matrix(-0.947, -0.323, -0.148, 0.966, -492.49, -86.99)"
				xlinkHref="#d"
			/>{" "}
			<linearGradient id="ak" x1="-645.333" y1="-334.169" x2="-642.973" y2="-332.091" xlinkHref="#j" />{" "}
			<linearGradient
				id="al"
				x1="-525.581"
				y1="-61.015"
			...
			<linearGradient
				...
				xlinkHref="#d"
			/>{" "}
			<linearGradient id="ar" x1="-649.116" y1="-328.591" x2="-646.827" y2="-326.795" xlinkHref="#j" />{" "}
			<linearGradient
				id="as"
				x1="-672.284"
				y1="-187.303"
			...
			>
				{" "}
				<stop offset="0" stopColor="#ffdb57" /> <stop offset="1" stopColor="#b66512" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="bc"
				x1="-628.479"
				...
				x2="-627.663"
				y2="-209.203"
				gradientTransform="matrix(-0.79, -0.614, -0.614, 0.79, -612.222, -211.392)"
				xlinkHref="#a"
			/>{" "}
			<linearGradient
				id="bd"
			...
			<linearGradient
				...
				x2="245.923"
				y2="136.367"
				gradientTransform="translate(-214.883 -165.485) rotate(7.312)"
				xlinkHref="#e"
			/>{" "}
			<linearGradient
				id="bh"
		...
		<rect
			...
			width="4.622"
			height="1.4"
			transform="translate(-5.405 8.973) rotate(-26.171)"
			style={{ fill: "url(#i)" }}
		/>{" "}
		<path
			d="M18.128,14.582l-.8.392.617,1.256.8-.392Zm-1.319.648.617,1.256.308-.152-.617-1.256Z"
			style={{ fill: "url(#j)" }}
		/>{" "}
		<path
		...
		<polygon
			points="22.287 28.694 22.714 28.484 17.92 18.73 16.892 17.176 17.494 18.94 22.287 28.694"
			style={{ fill: "url(#m)" }}
		/>{" "}
		<polygon points="16.892 17.176 22.5 28.589 22.287 28.694 17.494 18.94 16.892 17.176" style={{ fill: "url(#n)" }} />{" "}
		<polygon
			points="21.481 29.09 21.908 28.881 17.114 19.126 16.086 17.572 16.688 19.336 21.481 29.09"
			style={{ fill: "url(#o)" }}
		/>{" "}
		<polygon
			points="16.086 17.572 21.694 28.985 21.481 29.09 16.688 19.336 16.086 17.572"
			style={{ fill: "url(#p)" }}
		/>{" "}
		<path
		...
		/>{" "}
		<polygon
			points="15.018 18.247 20.374 29.244 20.57 28.971 15.179 17.939 15.018 18.247"
			style={{ fill: "url(#r)" }}
		/>{" "}
		<polygon
			points="20.436 29.315 20.647 29.024 21.352 29.385 21.149 29.679 20.436 29.315"
			style={{ fill: "url(#s)" }}
		/>{" "}
		...
		<polygon
			points="13.946 16.506 13.707 16.938 10.763 16.177 10.887 15.832 13.946 16.506"
			style={{ fill: "url(#v)" }}
		/>{" "}
		<path d="M9.359,13s-.145.444-.087.563l1.212,2.465.2-.384Z" style={{ fill: "url(#w)" }} />{" "}
		<path
			d="M16.683,10.624l.1-.327-2.963.095a.914.914,0,0,0-.51.251l-.007.165a1.871,1.871,0,0,1,.394-.1Z"
			style={{ fill: "url(#x)" }}
		/>{" "}
		<path
		...
		/>{" "}
		<polygon
			points="11.056 16.181 15.43 17.672 15.638 16.32 11.264 14.828 11.056 16.181"
			style={{ fill: "url(#aj)" }}
		/>{" "}
		<path
			d="M15.388,16.234l-.842-.287L14.339,17.3l.841.287ZM14,15.76l-.208,1.353.325.111.208-1.353Z"
			style={{ fill: "url(#ak)" }}
		/>{" "}
		<path
		...
		<polygon
			points="10.877 29.44 11.327 29.594 12.941 19.093 12.99 17.23 12.491 18.939 10.877 29.44"
			style={{ fill: "url(#an)" }}
		/>{" "}
		<polygon points="12.99 17.23 11.102 29.517 10.877 29.44 12.491 18.939 12.99 17.23" style={{ fill: "url(#ao)" }} />{" "}
		<polygon
			points="10.028 29.151 10.477 29.304 12.091 18.803 12.14 16.94 11.641 18.65 10.028 29.151"
			style={{ fill: "url(#ap)" }}
		/>{" "}
		...
		<polygon
			points="11.024 14.816 10.633 14.936 10.392 16.303 10.821 16.26 11.024 14.816"
			style={{ fill: "url(#av)" }}
		/>{" "}
		...
		<path
			d="M16.435,12.332l.256-.168-2.375-2.052a.962.962,0,0,0-.538-.183l-.1.115a2.143,2.143,0,0,1,.362.211Z"
			style={{ fill: "url(#ay)" }}
		/>{" "}
		<path
...
export default FileTypeLicense
