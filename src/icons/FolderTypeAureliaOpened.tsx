...
const FolderTypeAureliaOpened = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		/>{" "}
		<polygon
			points="26.32 22.391 25.724 21.498 26.855 20.743 27.451 21.636 26.32 22.391 26.32 22.391"
			style={{ fill: "url(#e)" }}
		/>{" "}
		<path
			d="M12.831,21.033l-.677.452L10.094,18.4l3.1-2.068,1.444,2.164-2.421,1.616,2.421-1.616.616.923-2.421,1.616Z"
			style={{ fill: "url(#f)" }}
		/>{" "}
		<path
			d="M19.763,15.072l.616.923-4.07,2.716-.616-.923-3.385-5.072L16.378,10l3.385,5.072Z"
			style={{ fill: "url(#g)" }}
		/>{" "}
		...
		<rect
			...
			width="1.384"
			height="1.384"
			transform="translate(-6.558 8.948) rotate(-33.716)"
			style={{ fill: "#9e61ad" }}
		/>{" "}
		<rect
			x="14.942"
			...
			width="1.384"
			height="1.384"
			transform="translate(-13.521 13.572) rotate(-33.716)"
			style={{ fill: "#8053a3" }}
		/>{" "}
		<path d="M12.8,29.3,9.426,24.2,27.439,12.156l3.534,5.011L12.8,29.3Z" style={{ fill: "url(#i)" }} />{" "}
	</svg>
)
export default FolderTypeAureliaOpened
