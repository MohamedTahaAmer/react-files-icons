...
const FileTypeMatlab = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#512" /> <stop offset="0.23" stopColor="#523" />{" "}
				<stop offset="0.36" stopColor="#534" /> <stop offset="0.51" stopColor="#645" />{" "}
				<stop offset="0.66" stopColor="#568" /> <stop offset="0.84" stopColor="#29d" />{" "}
			</linearGradient>{" "}
			<linearGradient id="b" x1="29.71" y1="18.983" x2="11.71" y2="14.563" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0.081" stopColor="#c33" /> <stop offset="0.189" stopColor="#de5239" />{" "}
				<stop offset="0.313" stopColor="#f06e3e" /> <stop offset="0.421" stopColor="#fa8042" />{" "}
				<stop offset="0.5" stopColor="#fe8643" /> <stop offset="0.58" stopColor="#fa7f42" />{" "}
				<stop offset="0.696" stopColor="#ef6c3e" /> <stop offset="0.833" stopColor="#dc4c37" />{" "}
