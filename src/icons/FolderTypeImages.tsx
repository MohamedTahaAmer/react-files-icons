...
const FolderTypeImages = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>folder_type_images</title>{" "}
		<path d="M27.5,5.5H18.2L16.1,9.7H4.4V26.5H29.6V5.5Zm0,4.2H19.3l1.1-2.1h7.1Z" style={{ fill: "#55bfa0" }} />{" "}
		<path d="M31,15.778Q31,23.39,31,31H10q0-7.612,0-15.223H31" style={{ fill: "#2dcc9f" }} />{" "}
