...
const FileTypeElasticbeanstalk = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_elasticbeanstalk</title>{" "}
		<polygon
			points="12.534 3.733 12.534 16 11.107 16 11.107 27.553 16 30 18.956 16 16 2 12.534 3.733"
			style={{ fill: "#9d5025" }}
		/>{" "}
		<polygon
			points="16 2 16 16 16 30 19.466 28.267 19.466 16 20.893 16 20.893 4.447 16 2"
			style={{ fill: "#f58536" }}
		/>{" "}
