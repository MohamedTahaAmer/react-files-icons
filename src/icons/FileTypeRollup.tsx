...
const FileTypeRollup = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#ff6533" /> <stop offset="0.157" stopColor="#ff5633" />{" "}
				<stop offset="0.434" stopColor="#ff4333" /> <stop offset="0.714" stopColor="#ff3733" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#bf3338" /> <stop offset="1" stopColor="#f33" />{" "}
			</linearGradient>{" "}
			<linearGradient id="c" x1="12.406" y1="-186.476" x2="14.368" y2="-188.536" xlinkHref="#a" />{" "}
			<linearGradient id="d" x1="15.974" y1="-190.023" x2="15.385" y2="-181.584" xlinkHref="#a" />{" "}
			<linearGradient
				id="e"
				x1="13.423"
				y1="-186.331"
			...
			>
				{" "}
				<stop offset="0" stopColor="#fbb040" /> <stop offset="1" stopColor="#fb8840" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="f"
				x1="16.279"
		...
		<path
			...
			style={{ opacity: "0.300000011920929", isolation: "isolate", fill: "url(#f)" }}
		/>{" "}
	</svg>
)
export default FileTypeRollup
