...
const FileTypePrecommit = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_precommit</title>{" "}
		<path
			d="M29.3,17.7,17.7,29.3a2.42,2.42,0,0,1-3.41,0L2.7,17.7a2.42,2.42,0,0,1,0-3.41L14.3,2.7a2.42,2.42,0,0,1,3.41,0L29.3,14.3A2.42,2.42,0,0,1,29.3,17.7Z"
			style={{ fill: "#f8b424" }}
		/>{" "}
...
export default FileTypePrecommit
