...
const FileTypePurescript = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_purescript</title> <rect width="32" height="32" style={{ fill: "#16171b" }} />{" "}
		...
		<path
			d="M9.1,13.926,7.652,12.482,2.3,17.836a1.023,1.023,0,0,0,0,1.443l5.354,5.354L9.1,23.19,4.464,18.558Z"
			style={{ fill: "#fff" }}
		/>{" "}
		<path
