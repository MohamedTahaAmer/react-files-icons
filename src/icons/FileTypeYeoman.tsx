...
const FileTypeYeoman = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<path
			d="M25.706,16.847,27.4,7.03S24.849,2,16.037,2C5.344,2,4.562,7.03,4.562,7.03l1.714,9.817Z"
			style={{ fill: "#050505" }}
		/>{" "}
		...
		/>{" "}
		<path
			d="M15.981,22.983s1.937-2.31,6.483-1.174,6.874,6.762,6.874,6.762a9.244,9.244,0,0,1-6.352,1.341C19.111,29.41,15.963,25.275,15.981,22.983Z"
			style={{ fill: "#4f1907" }}
		/>{" "}
		<path
			d="M8.977,29.913a9.244,9.244,0,0,1-6.352-1.341S4.953,22.946,9.5,21.809s6.483,1.174,6.483,1.174C16,25.274,12.851,29.41,8.977,29.913Z"
			style={{ fill: "#4f1907" }}
		/>{" "}
	</svg>
)
export default FileTypeYeoman
