...
const FileTypeHygen = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<path
			...
			style={{ fill: "#c9c9c9", fillRule: "evenodd" }}
		/>{" "}
		<path d="M16.169,30V22.337a6.167,6.167,0,0,1,6.168-6.168H30Z" style={{ fill: "#fff", fillRule: "evenodd" }} />{" "}
