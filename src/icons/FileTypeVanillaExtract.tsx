...
const FileTypeVanillaExtract = (props: SVGProps<SVGSVGElement>) => (
	<svg
		{...props}
		id="Layer_2"
		data-name="Layer 2"
	...
	>
		...
		<defs>
			...
			<radialGradient
				...
				cy="653.31"
				r="1"
				gradientTransform="matrix(0, 6.25, 9.79, 0, -6381.77, 5391.66)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0.47" stopColor="#7a4c33" /> <stop offset="1" stopColor="#52423c" />{" "}
			</radialGradient>{" "}
			<linearGradient
				id="linear-gradient"
				x1="6.39"
			...
			>
				{" "}
				<stop offset="0" stopColor="#ff85ae" /> <stop offset="0.32" stopColor="#ff7da9" />{" "}
				<stop offset="0.82" stopColor="#ff669a" /> <stop offset="1" stopColor="#ff5c93" />{" "}
			</linearGradient>{" "}
			<linearGradient
			...
			>
				{" "}
				<stop offset="0" stopColor="#ffb0cb" /> <stop offset="0.79" stopColor="#f383a9" />{" "}
				<stop offset="1" stopColor="#f0769f" />{" "}
			</linearGradient>{" "}
			<linearGradient
			...
			>
				{" "}
				<stop offset="0" stopColor="#f697b7" /> <stop offset="0.34" stopColor="#f78fb2" />{" "}
				<stop offset="0.86" stopColor="#f878a3" /> <stop offset="1" stopColor="#f9719f" />{" "}
			</linearGradient>{" "}
			<linearGradient
			...
			>
				{" "}
				<stop offset="0" stopColor="#f78fb2" /> <stop offset="0.27" stopColor="#f887ad" />{" "}
				<stop offset="0.7" stopColor="#fc709f" /> <stop offset="1" stopColor="#ff5c93" />{" "}
			</linearGradient>{" "}
			<linearGradient
			...
			>
				{" "}
				<stop offset="0" stopColor="#4fe8ff" /> <stop offset="0.5" stopColor="#4bddf3" />{" "}
				<stop offset="1" stopColor="#45cee3" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		<path
		...
		/>{" "}
		<path
			d="M16.17,23.14c5.82,0,10.55-1.9,10.55-4.24S22,14.66,16.17,14.66,5.62,16.56,5.62,18.9,10.34,23.14,16.17,23.14Z"
		...
		/>{" "}
		<path
			d="M25.12,12.85c-.94,5.67-9.61,3.71-14.07,5.26a.92.92,0,0,0-.5.21c3.6,1.16,8,1.4,10.94.42C25.18,17.51,26.85,14.6,25.12,12.85Z"
			style={{ fill: "#eb5e8e" }}
		/>{" "}
		<path
...
export default FileTypeVanillaExtract
