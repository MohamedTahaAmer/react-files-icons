...
const FileTypeRed = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient
				...
				x2="-547"
				y2="-244.974"
				gradientTransform="matrix(4, 0, 0, -4, 2204, -974)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0" stopColor="#eea831" /> <stop offset="1" stopColor="#ffc929" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="-547"
			...
			>
				{" "}
				<stop offset="0" stopColor="#b32629" /> <stop offset="0.583" stopColor="#8c1e21" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#e8a333" /> <stop offset="0.612" stopColor="#c68931" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#ae2524" /> <stop offset="0.563" stopColor="#d01d19" />{" "}
				<stop offset="1" stopColor="#ed1913" />{" "}
			</linearGradient>{" "}
			<linearGradient id="f" x1="-549.238" y1="-247.171" y2="-247.171" xlinkHref="#e" />{" "}
		</defs>{" "}
		<title>file_type_red2</title> <polygon points="16 9.792 16 2 12.097 7.77 16 9.792" style={{ fill: "url(#a)" }} />{" "}
