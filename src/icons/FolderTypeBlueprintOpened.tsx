...
const FolderTypeBlueprintOpened = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<radialGradient id="a" cx="19.64" cy="19.72" r="15.24" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#138fce" /> <stop offset="0.857" stopColor="#385eaa" />{" "}
				<stop offset="0.929" stopColor="#3265af" />{" "}
			</radialGradient>{" "}
		</defs>{" "}
