...
const FileTypeFlutterPackage = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 254.5 225">
		{" "}
		...
		/>{" "}
		<path
			d="M105.511,13.158h34.056c3.678,16.8,7.648,33.52,11.4,50.3H94.012C97.887,46.71,101.62,29.914,105.511,13.158Z"
			style={{ fill: "#efc75e" }}
		/>{" "}
		<path
		...
		/>{" "}
		<polygon
			points="102.086 125.433 128.276 152.245 240.469 39.123 188.394 39.123 102.086 125.433"
			style={{ fill: "#41d0fd" }}
		/>{" "}
		<polygon
			points="141.191 165.066 167.751 191.234 194.338 164.805 167.429 139.1 141.191 165.066"
			style={{ fill: "#1fbcfd" }}
		/>{" "}
		<polygon
			points="167.751 191.234 194.338 164.805 239.819 210.806 187.452 210.806 167.751 191.234"
			style={{ fill: "#095a9d" }}
		/>{" "}
		<polygon points="167.751 191.234 192.519 182.998 184.173 174.91 167.751 191.234" style={{ fill: "#0e5199" }} />{" "}
	</svg>
)
export default FileTypeFlutterPackage
