...
const FileTypeCert = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		/>{" "}
		<path
			d="M16,5.5a5.264,5.264,0,0,0-5.25,5.25v4.375H8.125V26.5h15.75V15.125H21.25V10.75A5.264,5.264,0,0,0,16,5.5Zm0,1.75a3.487,3.487,0,0,1,3.5,3.5v4.375h-7V10.75A3.487,3.487,0,0,1,16,7.25Z"
			style={{ fill: "#00c800" }}
		/>{" "}
		<path
