...
const FileTypeAutohotkey = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient
				...
				x2="54.604"
				y2="194.885"
				gradientTransform="translate(-38.604 -165.636)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0" stopColor="#d8d8d8" /> <stop offset="1" stopColor="#a3a3a3" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="68.756"
				...
				x2="91.638"
				y2="209.152"
				gradientTransform="translate(-50.601 -159.449) scale(0.832 0.837)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0" stopColor="#d7d7d7" /> <stop offset="0.5" stopColor="#e7e7e7" />{" "}
