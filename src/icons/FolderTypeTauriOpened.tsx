...
const FolderTypeTauriOpened = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>folder_type_tauri_opened</title>{" "}
		<path
			d="M27.4,5.5H18.2L16.1,9.7H4.3V26.5H29.5V5.5Zm0,18.7H6.6V11.8H27.4Zm0-14.5H19.2l1-2.1h7.1V9.7Z"
			style={{ fill: "#465166" }}
		/>{" "}
		<polygon points="25.7 13.7 0.5 13.7 4.3 26.5 29.5 26.5 25.7 13.7" style={{ fill: "#465166" }} />{" "}
		<path d="M25.36,17.64a2,2,0,1,1-2-2A2,2,0,0,1,25.36,17.64Z" style={{ fill: "#ffc131" }} />{" "}
