...
const FileTypeFlash = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient id="a" x1="28.841" y1="29.545" x2="3.828" y2="3.161" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#b42025" /> <stop offset="1" stopColor="#d42027" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		<title>file_type_flash</title> <rect x="2" y="2.328" width="28" height="27.344" style={{ fill: "url(#a)" }} />{" "}
		<path
