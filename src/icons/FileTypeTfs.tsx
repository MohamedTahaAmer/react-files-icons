...
const FileTypeTfs = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<rect
			...
			width="8.189"
			height="2.801"
			transform="translate(-1.301 5.119) rotate(-14.233)"
			style={{ fill: "#68217a" }}
		/>{" "}
		<rect
			x="3.834"
			...
			width="7.601"
			height="2.802"
			transform="translate(-13.621 22.479) rotate(-75.774)"
			style={{ fill: "#68217a" }}
		/>{" "}
		<rect
			x="17.171"
			...
			width="2.801"
			height="9.292"
			transform="translate(-7.805 18.485) rotate(-44.709)"
			style={{ fill: "#68217a" }}
		/>{" "}
	</svg>
)
