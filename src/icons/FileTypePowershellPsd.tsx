...
const FileTypePowershellPsd = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#fc5454" /> <stop offset="1" stopColor="#af4343" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="7.1"
			...
			>
				{" "}
				<stop offset="0" stopColor="#fc5454" /> <stop offset="1" stopColor="#bc3f3f" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		...
		<path
			...
			style={{ fill: "#8e2d2d", fillRule: "evenodd" }}
		/>{" "}
		<path
