...
const FileTypeBat = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<polygon points="24.811 27.318 27.215 24.914 28.417 27.318 27.215 28.52 24.811 27.318" style={{ fill: "silver" }} />{" "}
		<polygon
		...
		<polygon
			...
			style={{ fill: "silver" }}
		/>{" "}
		<polygon points="20.664 18.157 18.26 20.561 17.058 18.157 18.26 16.954 20.664 18.157" style={{ fill: "silver" }} />{" "}
		<polygon points="24.51 18.032 21.11 18.032 21.96 15.482 23.66 15.482 24.51 18.032" style={{ fill: "silver" }} />{" "}
		<polygon points="27.318 20.664 24.914 18.26 27.318 17.058 28.52 18.26 27.318 20.664" style={{ fill: "silver" }} />{" "}
		<polygon points="27.443 24.51 27.443 21.11 29.993 21.96 29.993 23.66 27.443 24.51" style={{ fill: "silver" }} />{" "}
		<path
		...
		<path
			...
			style={{ fill: "#a9a9a9" }}
		/>{" "}
		<polygon points="6.563 16.976 8.838 18.238 7.374 19.806 6.009 19.049 6.563 16.976" style={{ fill: "silver" }} />{" "}
		<polygon points="4.382 13.834 5.722 16.064 3.67 16.69 2.866 15.352 4.382 13.834" style={{ fill: "silver" }} />{" "}
		<polygon points="4.065 10.023 4.11 12.624 2.02 12.14 1.993 10.579 4.065 10.023" style={{ fill: "silver" }} />{" "}
		<polygon points="5.696 6.563 4.434 8.838 2.866 7.374 3.623 6.009 5.696 6.563" style={{ fill: "silver" }} />{" "}
		<polygon points="8.838 4.382 6.608 5.722 5.982 3.67 7.32 2.866 8.838 4.382" style={{ fill: "silver" }} />{" "}
		<polygon points="12.65 4.065 10.048 4.11 10.532 2.02 12.093 1.993 12.65 4.065" style={{ fill: "silver" }} />{" "}
		<polygon points="16.109 5.696 13.834 4.434 15.298 2.866 16.663 3.623 16.109 5.696" style={{ fill: "silver" }} />{" "}
		<polygon points="18.29 8.838 16.95 6.608 19.002 5.982 19.806 7.32 18.29 8.838" style={{ fill: "silver" }} />{" "}
		<polygon points="18.607 12.65 18.562 10.048 20.652 10.532 20.679 12.093 18.607 12.65" style={{ fill: "silver" }} />{" "}
		<polygon
			points="16.976 16.109 18.238 13.834 19.806 15.298 19.049 16.663 16.976 16.109"
			style={{ fill: "silver" }}
		/>{" "}
		<polygon points="13.834 18.29 16.064 16.95 16.69 19.002 15.352 19.806 13.834 18.29" style={{ fill: "silver" }} />{" "}
		<polygon points="10.023 18.607 12.624 18.562 12.14 20.652 10.579 20.679 10.023 18.607" style={{ fill: "silver" }} />{" "}
		<path
