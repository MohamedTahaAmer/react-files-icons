...
const FileTypePaket = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<radialGradient
				...
				cy="-818.913"
				r="48.27"
				gradientTransform="matrix(0.36, 0.402, 0.222, -0.163, 197.796, -86.468)"
			...
			<radialGradient
				...
				cy="-1187.763"
				r="83.239"
				gradientTransform="matrix(0.031, 0.03, 0.075, -0.062, -28.337, -144.76)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
			...
			<radialGradient
				...
				cy="-509.943"
				r="27.886"
				gradientTransform="matrix(-1.048, -0.5, -1.117, 0.527, -829.648, 192.721)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
