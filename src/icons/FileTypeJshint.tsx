...
const FileTypeJshint = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_jshint</title> <rect x="2" y="2.005" width="28" height="27.991" style={{ fill: "#818180" }} />{" "}
		<path
			d="M9.353,25.372l2.14-1.295c.413.732.788,1.351,1.689,1.351.863,0,1.408-.338,1.408-1.652V14.842h2.628v8.972c0,2.722-1.6,3.961-3.923,3.961a4.078,4.078,0,0,1-3.942-2.4"
			style={{ fill: "#2d2d2c" }}
		/>{" "}
		<path
