...
const FileTypePlantuml = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#767676" /> <stop offset="1" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="-32.107"
			...
			>
				{" "}
				<stop offset="0" stopColor="#0079b9" /> <stop offset="1" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="c"
				x1="-33.282"
			...
			<linearGradient id="d" x1="12.356" y1="26.268" x2="14.011" y2="26.268" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#595959" /> <stop offset="0.087" stopColor="#6e6e6e" />{" "}
				<stop offset="0.242" stopColor="#8c8c8c" /> <stop offset="0.405" stopColor="#a4a4a4" />{" "}
				<stop offset="0.577" stopColor="#b5b5b5" /> <stop offset="0.765" stopColor="#bfbfbf" />{" "}
				<stop offset="1" stopColor="#c2c2c2" />{" "}
			</linearGradient>{" "}
			<linearGradient id="e" x1="18.291" y1="26.171" x2="19.946" y2="26.171" xlinkHref="#d" />{" "}
			<linearGradient id="f" x1="24.44" y1="26.171" x2="26.096" y2="26.171" xlinkHref="#d" />{" "}
		</defs>{" "}
		...
		<polygon
			points="26.401 11.909 29.418 13.592 27.07 15.088 24.213 13.247 26.401 11.909"
			style={{ fill: "url(#a)" }}
		/>{" "}
		<path d="M27.069,15.215l-3.058-1.97,2.387-1.46,3.228,1.8Zm-2.654-1.966L27.07,14.96,29.208,13.6l-2.8-1.565Z" />{" "}
		<polygon
			points="14.498 17.807 21.354 22.354 15.914 25.429 9.055 20.935 14.498 17.807"
			style={{ fill: "#ffbd3f" }}
		/>{" "}
		...
		<polygon
			points="24.071 13.343 27.009 15.222 27.009 22.131 24.071 20.247 24.071 13.343"
			style={{ fill: "url(#c)" }}
		/>{" "}
		<path d="M27.063,22.229l-3.045-1.953V13.245l3.045,1.947Zm-2.938-2.012,2.831,1.815V15.251l-2.831-1.81Z" />{" "}
		<polygon
			points="27.149 22.526 27.149 15.194 29.514 13.775 29.514 29.149 28.331 29.149 9.646 29.149 9.646 25.601 15.086 22.526 15.785 25.601 15.796 25.601 21.472 22.526 21.891 25.601 21.945 25.601 27.149 22.526"
			style={{ fill: "#fff" }}
		/>{" "}
		...
		<path
			d="M27.215,11.23c-.052.069-.417-.262-.653-.526a4.408,4.408,0,0,1-.516-.73A2.6,2.6,0,0,1,25.7,9.2a2.358,2.358,0,0,1-.052-.682,2.959,2.959,0,0,1,.129-.749,3.142,3.142,0,0,1,.787-1.207,15.532,15.532,0,0,0,1.283-1.4,3.062,3.062,0,0,0,.479-.927,3.979,3.979,0,0,0,.151-.855c.019-.364-.025-.593.023-.613s.215.274.287.564a3.167,3.167,0,0,1-.458,2.1,6.9,6.9,0,0,1-1.094,1.448,2.8,2.8,0,0,0-.849,1.234A2.466,2.466,0,0,0,26.3,8.8a3.465,3.465,0,0,0,.476,1.542C27.064,10.914,27.256,11.175,27.215,11.23Z"
			style={{ fill: "#ea2d2e" }}
		/>{" "}
		...
		<path
			d="M29.972,6.087c-.019-.088-.432-.04-.766.073a2.6,2.6,0,0,0-1.059.722,2.8,2.8,0,0,0-.916,1.855,2.972,2.972,0,0,0,.258,1.06c.221.572.455.773.444,1.225-.007.3-.114.484-.048.549s.314-.1.462-.313a1.8,1.8,0,0,0,.259-1.022c-.046-.815-.6-1.015-.608-1.8a1.858,1.858,0,0,1,.129-.676C28.57,6.509,30.008,6.252,29.972,6.087Z"
			style={{ fill: "#ea2d2e" }}
		/>{" "}
...
export default FileTypePlantuml
