...
const FileTypeFirestore = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_firestore</title>{" "}
		<path
			d="M5.8,24.6l.17-.237L13.99,9.149l.017-.161-3.535-6.64a.656.656,0,0,0-1.227.207Z"
			style={{ fill: "#ffc24a" }}
		/>{" "}
		...
		/>{" "}
		<path
			d="M16.537,13.9,19.1,11.28,16.537,6.4a.589.589,0,0,0-1.074-.047L14.049,9.082l-.042.139Z"
			style={{ fill: "#ffa50e" }}
		/>{" "}
		<polygon
		...
		/>{" "}
		<polygon
			points="23.201 13 15.405 16.534 15.405 27.603 21.625 24.785 21.625 31 31 26.743 31 16.534 23.201 13"
			style={{ fill: "#252525" }}
		/>{" "}
		<polygon
			points="23.201 14.73 16.985 17.549 16.985 20.327 23.201 17.507 29.421 20.327 29.421 17.549 23.201 14.73"
			style={{ fill: "#fff" }}
		/>{" "}
		<polygon
			points="23.201 19.564 16.985 22.381 16.985 25.158 23.201 22.337 29.421 25.158 29.421 22.381 23.201 19.564"
			style={{ fill: "#fff" }}
		/>{" "}
