...
const FolderTypeDist = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient id="a" x1="20.698" y1="23.259" x2="17.514" y2="34.062" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#f1f1f2" /> <stop offset="0.391" stopColor="#eaebec" />{" "}
				<stop offset="1" stopColor="#e6e7e8" />{" "}
			</linearGradient>{" "}
			<linearGradient id="b" x1="29.221" y1="11.689" x2="30.358" y2="36.594" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#e6e7e8" /> <stop offset="0.482" stopColor="#dbdcde" />{" "}
				<stop offset="1" stopColor="#d7d8da" />{" "}
			</linearGradient>{" "}
			<linearGradient id="c" x1="26.177" y1="9.571" x2="16.325" y2="19.482" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#fff57e" /> <stop offset="1" stopColor="#fdbf0f" />{" "}
			</linearGradient>{" "}
			<linearGradient id="d" x1="28.842" y1="10.318" x2="30.965" y2="21.502" gradientUnits="userSpaceOnUse">
				{" "}
				<stop offset="0" stopColor="#fbe574" /> <stop offset="1" stopColor="#efab14" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		<title>folder_type_dist</title>{" "}
		<path d="M27.5,5.5H18.2L16.1,9.7H4.4V26.5H29.6V5.5Zm0,4.2H19.3l1.1-2.1h7.1Z" style={{ fill: "#bc9f55" }} />{" "}
