...
const FileTypeAffinitydesigner = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<radialGradient id="a" cx="13.769" cy="17.09" r="11.945" gradientUnits="userSpaceOnUse">
			{" "}
			<stop offset="0" stopColor="#06dbe0" /> <stop offset="1" stopColor="#3b63ff" />{" "}
		</radialGradient>{" "}
		...
		<linearGradient id="b" gradientUnits="userSpaceOnUse" x1="15.5" y1="16.5" x2="22.3" y2="13">
			{" "}
			<stop offset="0" stopColor="#1dffb8" /> <stop offset="1" stopColor="#00d2f8" />{" "}
		</linearGradient>{" "}
		<path
			d="M14.378 18.085h2.682l-1.948-3.387-1.345 2.328a.706.706 0 0 0 .611 1.059zM19.233 7.562l-3.8 6.581 2.267 3.942h7.585z"
			fill="url(#b)"
		/>{" "}
	</svg>
)
