...
const FileTypeJsonnet = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_jsonnet</title> <path d="M30,16A14,14,0,1,1,16,2,14,14,0,0,1,30,16Z" style={{ fill: "#0064bd" }} />{" "}
		<path d="M20.086,22.537,16.817,20.9V17.634l3.269,1.634Z" style={{ fill: "#fff", fillRule: "evenodd" }} />{" "}
		<path
			...
			style={{ fill: "#bfbfbf", fillRule: "evenodd" }}
		/>{" "}
		<path
			...
			style={{ fill: "gray", fillRule: "evenodd" }}
		/>{" "}
		<path
