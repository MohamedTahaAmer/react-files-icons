...
const FileTypeCmake = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#1011a1" /> <stop offset="1" stopColor="#6969e1" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="16.231"
			...
			>
				{" "}
				<stop offset="0" stopColor="#b40e0e" /> <stop offset="1" stopColor="#ff5959" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="c"
				x1="21.663"
			...
			>
				{" "}
				<stop offset="0" stopColor="#01a300" /> <stop offset="1" stopColor="#01df00" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="d"
				x1="14.643"
			...
			>
				{" "}
				<stop offset="0" stopColor="#848484" /> <stop offset="1" stopColor="#d2d2d2" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		<title>file_type_cmake</title> <path d="M17.257,16.919,2.246,29.749,15.994,2.283Z" style={{ fill: "url(#a)" }} />{" "}
