...
const FileTypeCaddy = (props: SVGProps<SVGSVGElement>) => (
		...
		<g>
			...
			<g>
				...
				<g clipPath="url(#clip)">
					...
					>
						{" "}
						<stop offset="0" style={{ stopColor: "#B7B7B7" }} /> <stop offset="0.5" style={{ stopColor: "#FFFFFF" }} />{" "}
						<stop offset="1" style={{ stopColor: "#B2B2B2" }} />{" "}
					</linearGradient>{" "}
					<path
					...
					>
						{" "}
						<stop offset="0.1" style={{ stopColor: "#323232" }} />{" "}
						<stop offset="0.5" style={{ stopColor: "#636363" }} /> <stop offset="1" style={{ stopColor: "#272727" }} />{" "}
					</linearGradient>{" "}
					<path
					...
					>
						{" "}
						<stop offset="0.1" style={{ stopColor: "#FFFFFF" }} />{" "}
