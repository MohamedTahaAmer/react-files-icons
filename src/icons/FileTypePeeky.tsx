...
const FileTypePeeky = (props: SVGProps<SVGSVGElement>) => (
	<svg
		{...props}
		id="Layer_2"
		data-name="Layer 2"
	...
	>
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#0029ff" /> <stop offset="1" stopColor="#bd00ff" />{" "}
			</radialGradient>{" "}
		</defs>{" "}
		<rect id="rect531" x="5.1" y="11" width="21.49" height="12.52" style={{ fill: "#fff" }} />{" "}
		<path
			id="path95"
			d="M11.13,16.06a.85.85,0,1,1-.84-.9A.87.87,0,0,1,11.13,16.06Z"
			style={{ fill: "url(#radial-gradient)" }}
		/>{" "}
		<path
			id="path97"
			d="M20.8,16.06a.85.85,0,1,0,.85-.9A.88.88,0,0,0,20.8,16.06Z"
			style={{ fill: "url(#radial-gradient)" }}
		/>{" "}
		<path
			id="path99"
			...
			style={{ fillRule: "evenodd", fill: "url(#radial-gradient)" }}
		/>{" "}
	</svg>
)
