...
const FileTypeMaya = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#0f6067" /> <stop offset="0.5" stopColor="#05abac" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#117c83" /> <stop offset="0.5" stopColor="#21b5b5" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#9accd3" /> <stop offset="0.5" stopColor="#72aeb3" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#21626e" /> <stop offset="0.5" stopColor="#157c84" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#0b7c81" /> <stop offset="0.5" stopColor="#068d90" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#0a8a8f" /> <stop offset="0.5" stopColor="#0f7c82" />{" "}
			...
			>
				{" "}
				<stop offset="0" stopColor="#256a77" /> <stop offset="0.5" stopColor="#0d9499" />{" "}
