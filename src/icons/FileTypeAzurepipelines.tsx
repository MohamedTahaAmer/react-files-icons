...
const FileTypeAzurepipelines = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			<linearGradient
				...
				x2="1.069"
				y2="31.569"
				gradientTransform="matrix(0, 29.091, 29.091, 0, -902.364, -0.545)"
				gradientUnits="userSpaceOnUse"
			>
				{" "}
				<stop offset="0" stopColor="#fff" /> <stop offset="1" stopColor="#fff" stopOpacity="0" />{" "}
			</linearGradient>{" "}
			<linearGradient id="c" x1="0.069" y1="31.194" x2="1.069" y2="31.194" xlinkHref="#b" />{" "}
		</defs>{" "}
		...
		<g style={{ mask: "url(#a)" }}>
			...
			<path
				d="M23.273,12.364a3.636,3.636,0,1,0-3.636-3.636A3.636,3.636,0,0,0,23.273,12.364Z"
				style={{ fill: "#0a44c2" }}
			/>{" "}
			<path
				d="M23.273,12.364a3.636,3.636,0,1,0-3.636-3.636A3.636,3.636,0,0,0,23.273,12.364Z"
...
export default FileTypeAzurepipelines
