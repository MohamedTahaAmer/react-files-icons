...
const FolderTypeGcpOpened = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>folder_type_gcp_opened</title>{" "}
		<path d="M27.9,6H18.2l-2,4H5V27H30V6ZM28,24H7V12H28Zm.1-14H20.3l1-2H28Z" style={{ fill: "#d17dcd" }} />{" "}
		<polygon points="25.9 14 0.3 14 4.1 27 29.7 27 25.9 14" style={{ fill: "#d17dcd" }} />{" "}
		<path
		...
		/>{" "}
		<path
			d="M13.738,31.028H18.95V26.856H13.738a2.6,2.6,0,0,1-1.076-.235l-.732.227-2.1,2.086-.183.732A6.743,6.743,0,0,0,13.738,31.028Z"
			style={{ fill: "#34a853" }}
		/>{" "}
		<path
