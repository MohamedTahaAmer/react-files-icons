...
const FileTypeNsi = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_nsi</title> <path d="M27.435,16.037,22.012,21.46l5.423,5.423" style={{ fill: "#00577b" }} />{" "}
