...
const FileTypeVite = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32">
		...
		<defs id="defs50">
			...
			>
				{" "}
				<stop stopColor="#41D1FF" id="stop38" /> <stop offset="1" stopColor="#BD34FE" id="stop40" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="paint1_linear"
				x1="194.651"
			...
			>
				{" "}
				<stop stopColor="#FFEA83" id="stop43" /> <stop offset=".0833" stopColor="#FFDD35" id="stop45" />{" "}
