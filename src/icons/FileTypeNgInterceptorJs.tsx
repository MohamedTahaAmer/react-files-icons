...
const FileTypeNgInterceptorJs = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		{" "}
		<title>file_type_ng_interceptor_js</title> <path d="M2.73,6.67,15.85,2V30L4.77,23.88Z" style={{ fill: "#7a9" }} />{" "}
