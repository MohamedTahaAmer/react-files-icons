...
const FileTypePowershellFormat = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32">
		...
		<defs>
			...
			>
				{" "}
				<stop offset="0" stopColor="#f4c058" /> <stop offset="1" stopColor="#a88745" />{" "}
			</linearGradient>{" "}
			<linearGradient
				id="b"
				x1="7.1"
			...
			>
				{" "}
				<stop offset="0" stopColor="#f4c058" /> <stop offset="1" stopColor="#b58f41" />{" "}
			</linearGradient>{" "}
		</defs>{" "}
		...
		<path
			...
			style={{ fill: "#87692e", fillRule: "evenodd" }}
		/>{" "}
		<path
