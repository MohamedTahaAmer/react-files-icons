...
describe("Icons test", () => {
  describe("files", () => {
    ...
    it("should return icons by special filenames, but defined by vscode langs", () => {
      expect([getIconNameForFile("Jenkinsfile"), getIconNameForFile("guardfile")]).toEqual(["file_type_groovy.svg", "file_type_ruby.svg"])
    })
    ...
    it("should return icons by extensions", () => {
      ...
      ]).toEqual(["file_type_testts.svg", "file_type_testts.svg", "file_type_light_json.svg", "file_type_light_jsmap.svg"])
    })

    it("should return icons by languages", () => {
      expect([getIconNameForFile("content.js"), getIconNameForFile("Index.script.ts"), getIconNameForFile("__main__.py")]).toEqual([
  ...
  describe("folders", () => {
    ...
    it("should return icons for opened folders", () => {
      expect([getIconNameForOpenFolder("images"), getIconNameForOpenFolder("src"), getIconNameForOpenFolder("locale")]).toEqual([
